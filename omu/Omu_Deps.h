/*
 * Omu_Deps.h --
 *   -- extensions for managing dependent variables
 *
 * rf, 7/31/01
 */
...
public:
  ...
  void alloc(int nx, int nu, int nxf);

  bool c_setup; // indicate setup process, i.e. call to set_linear* allowed
...
public:
  ...
  void alloc(int dim, int nx, int nu, int nxp, int nxf);
