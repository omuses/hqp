/*
 * Prg_DiDSfun.C -- class definition
 * (derived from Di example accessing Docp interface)
 *
 * rf, 05/05/01
 */

#include "Prg_DiDSfun.h"
...
IF_CLASS_DEFINE("DiDSfun", Prg_DiDSfun, Omu_Program);

//--------------------------------------------------------------------------
Prg_DiDSfun::Prg_DiDSfun()
{
  _K = 60;
  _nx = 2;
  _nu = 1;
...
//--------------------------------------------------------------------------
void Prg_DiDSfun::update(int kk,
