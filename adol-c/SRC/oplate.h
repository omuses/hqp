...
/* 
   -----------------------------------------------------------------
   File oplate.h of ADOL-C version 1.8.5             as of Nov/22/99
   -----------------------------------------------------------------
   Provides numeric values for the various opcodes used by ADOL-C.

   Last changes:
        991122 olvo  new op_codes:       eq_plus_prod
                                         eq_min_prod
                     for  y += x1 * x2  and   y -= x1 * x2  
        980924 olvo: deleted all int_* opcodes
        980820 olvo: new comparison strategy (opcodes changed)
        980714 olvo: removed operation code: mult_av_a
        980708 olvo: new operation code: neg_sign_a
                                         pos_sign_a
