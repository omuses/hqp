/*
   --------------------------------------------------------------
   File detexam-old.C of ADOL-C version 1.8.0     as of Dec/01/98
   --------------------------------------------------------------
   based on detexam.C version 1.7 

   Example: computation of determinants

   Last changes: 
     981201 olvo new headers
     980818 olvo unification with the other examples
