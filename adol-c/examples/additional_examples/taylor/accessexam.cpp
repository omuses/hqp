/*
   --------------------------------------------------------------
   File accessexam.C of ADOL-C version 1.8.0      as of Dec/01/98
   -------------------------------------------------------------- 

   Example: Test driver 'tensor_value(..)' and
            access of higher order tensors by 
            void pointer strategy

   Last changes: 
     981201 olvo         new headers
     980824 andrea/olvo  this version
