/*
   --------------------------------------------------------------
   File coordinates.C of ADOL-C version 1.8.0     as of Dec/01/98
   --------------------------------------------------------------

   Example: Test driver 'inverse_tensor_eval' 
            using transformation between Cartesian coordinates
...
/*--------------------------------------------------------------------------*/
  ...
  free((char*) *tensor); free((char*)tensor);
