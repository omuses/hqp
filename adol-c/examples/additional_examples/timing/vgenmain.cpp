...
/*
   --------------------------------------------------------------
   File vgenmain.C of ADOL-C version 1.8.0        as of Dec/01/98
   --------------------------------------------------------------

   Vector Generic Main File: 
       for use with function modules containing several vector
       function examples 
       (e.g. the sinple example in vfunc_simplevec.C)
