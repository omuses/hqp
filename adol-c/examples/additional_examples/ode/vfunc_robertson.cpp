...
/*
   --------------------------------------------------------------
   File vfunc_robertson.C 
   of ADOL-C version 1.8.0                        as of Nov/16/98
   --------------------------------------------------------------

   Example: function module containing the (Robertson test problem
   ...
   Last changes: 
     981116 olvo error corection in Robertsons function
