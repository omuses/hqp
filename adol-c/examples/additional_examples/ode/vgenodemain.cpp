/*
   --------------------------------------------------------------
   File vgenodemain.C of ADOL-C version 1.8.0     as of Dec/01/98
   --------------------------------------------------------------
   based on odexam.C/od2exam.C version 1.7 

   ODE Generic Main File: 
...
/*                                             ---> always                  */ 
  ...
  { fprintf(stdout,"    !!! zero timing !!!\n");
    ...
    rtu = 1.0; stu = 2.0/((double)degree)/(((double)degree)+1.0);
  }
