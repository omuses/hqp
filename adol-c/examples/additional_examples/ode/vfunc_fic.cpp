...
/*
   ...
   Example: function module containing the flow in a channel
   ...
   Last changes: 
     981027 olvo changed nint to nIntern to avoid conflict with 
                 math.h
...
/*--------------------------------------------------------------------------*/
/*                                                         The fic function */
int pdficfj ( int n, double* x, double* fvec, double r__, int nIntern )
{   /* Initialized data */
