...
#include "Hqp_IpSpLU.h"


//--------------------------------------------------------------------------
Hqp_IpSpLU::Hqp_IpSpLU()
{
  _n = _me = _m = 0;
  _CT = SMNULL;
  _J = SMNULL;
...
//--------------------------------------------------------------------------
SPMAT *Hqp_IpSpLU::sub_CTC(const PERM *px, SPMAT *Q)
...
//--------------------------------------------------------------------------
void Hqp_IpSpLU::init(const Hqp_Program *qp)
{
...
//--------------------------------------------------------------------------
void Hqp_IpSpLU::update(const Hqp_Program *qp)
{
  // prepare _J_raw
  sp_zero(_J_raw);
...
//--------------------------------------------------------------------------
void Hqp_IpSpLU::factor(const VEC *z, const VEC *w)
{
...
//--------------------------------------------------------------------------
Real Hqp_IpSpLU::solve(const VEC *r1, const VEC *r2, const VEC *r3,
		       VEC *dx, VEC *dy, VEC *dz)
{
  ...
  spLUsolve(_J_fct, _pivot, _r12, _xy);
